...
hcpv.plot(style='.', title="Number of highly correlated variables for each feature", xticks=[], xlabel="Features",
          ylabel="Number of highly correlated variables")
...
df_inc = pd.DataFrame(list(zip(features, number_inclusions)),
                      columns=['Regressors', 'Number of times included in the model'])
